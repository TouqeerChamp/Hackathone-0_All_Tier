...
|--------|--------|-------|-------------|
| 📥 **Inbox** | ✅ Ready | 1 | Contains new items requiring action |
| ⚡ **Needs Action** | ⚠️ Processing | 8 | Items that require processing |
| ✅ **Done** | ✅ Ready | 2 | Completed tasks and activities |
| 📝 **Logs** | ✅ Ready | 3 | System logs and activity records |
